...
const StepByStep = () => (
  <section className='bg-theme-very-light-yellow w-full p-6 text-lg'>
    ...
    <p>
      ...
      elektrische auto stelt hoge eisen aan jouw installatie en wil je
      tegelijkertijd andere huishoudelijke apparaten zoals een oven of magnetron
      te gebruiken, dan kan gebeuren dat een 1-fase aansluiting onvoldoende
      vermogen levert.
    </p>
    <p className='mt-2'>
      ...
      - dit wordt <i>selectiviteit</i> genoemd).
    </p>
    ...
    <p className='mt-2'>
      ...
      alle drie de fasen in jow huis zo ver mogelijk in evenwicht is. Zelfs met
      een moderne 3-fase aansluiting en relatief nieuwe installaties kan het dus
      nodig zijn dat je enkele wijzigingen in de verdeelkast moet aanbrengen.
    </p>
    <p className='mt-2'>
    ...
    <p className='mt-2'>
      ...
      laadpunten: één met ingebouwde DC-lekbeveiliging (RDC-DD) (8) en één
      zonder enige bescherming tegen DC-lekken (9). Voor het laadpunt met een
      RDC-DD is het toegestaan om een reguliere Type A aardlekschakelaar (4) te
      gebruiken, terwijl voor het laadpunt zonder DC-lekbeveiliging een Type B
      aardlekschakelaar (5) verplicht is. Een aardlekschakelaar Type B beschermt
    ...
    <p>
      ...
      vragen om de benodigde kabels aan te leggen. Wij kijken samen wat de beste
      plek is om jouw laadpunt te plaatsen.
    </p>
    <h3 className='my-4 text-left text-2xl font-semibold italic'>
      Het laadpunt kiezen
    </h3>
    <p>
      ...
      het laatste wat je moet doen het kiezen van het juiste laadpunt voor jouw
      installatie. Vaak komt het zelfs al eerder in beeld, omdat de keuze van
      jouw laadpunt ernstige gevolgen kan hebben voor jouw verdeelkast (beschikt
      het laadpunt over ingebouwde bescherming tegen DC-lekken?). Ik help je bij
      het vinden van een geschikt laadpunt van onze partners of zoeken wij naar
      alternatieve oplossingen als je bereid bent een beetje te experimenteren.
    ...
    <p>
      ...
      totale energieverbruik in jouw huis te monitoren en de maximale laadstroom
    ...
    <p className='mt-2'>
      ...
      tussenkomst van uw netwerkbeheerder nodig is om deze te herstellen, wat je
